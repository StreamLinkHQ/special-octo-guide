          ...
          {selectedType === AgendaAction.Custom && (
            <div className="p-4 sm:!p-6 bg-pink-50 rounded-lg sm:!rounded-xl">
              ...
              <div className="text-xs sm:!text-sm text-gray-600 bg-white p-3 sm:!p-4 rounded-lg border border-pink-200">
                ...
                <p>
                  Use the title and description fields above to define your
                  custom agenda.
                </p>
              </div>
            </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-0">
                ...
                {!selectedType && (
                  <div className="mt-6 p-4 bg-purple-50 rounded-xl text-sm text-purple-700">
                    ...
                    <p>
                      Mix different agenda types to keep your audience engaged
                ...
                <div className="relative">
                  ...
                  <div className="space-y-4 sm:!space-y-6">
                    {agendaItems
                      ...
                      .map((item) => {
                        const agendaType = agendaTypes.find(
                          (t) => t.type === item.action
                        );
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="text-xs sm:!text-sm text-gray-500">
                                    {item.action === AgendaAction.Poll &&
                                      "options" in item && (
                                        <span>
                                          {item.options.length} poll options
                                        </span>
                                      )}
