...
const PollTaker = () => {
  const { getPollContent, pollContent, isLoading, refresh } =
    useGetPollContent();
  ...
  useEffect(() => {
    if (activeAgendaId && activeAddonType === "Poll") {
      getPollContent(activeAgendaId);
    }
  }, [activeAgendaId, activeAddonType, getPollContent]);
  ...
  if (!pollContent || !pollContent.pollContent || options.length === 0) {
    return (
      <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-lg">
        <div className="text-center">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-red-700 mt-1">
                  Time has expired for this poll.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex-1">
              <div className="flex items-center mb-2">
                ...
                <h2 className="text-xl font-bold text-gray-900">
                  {pollContent.title || "Poll"}
                </h2>
              </div>
              {pollContent.description && (
                <p className="text-gray-700 mb-4">{pollContent.description}</p>
              )}
              ...
              <div className="flex flex-wrap gap-4 text-sm">
                ...
                {pollContent.duration && Number(pollContent.duration) > 0 && (
                  <div className="flex items-center gap-1">
                    <FaClock className="w-4 h-4 text-orange-600" />
                    <span className="text-orange-700 font-medium">
                      {Number(pollContent.duration)} minute
                      {Number(pollContent.duration) !== 1 ? "s" : ""} limit
                    </span>
                  </div>
                )}
          ...
          {publicKey && (
            <div className="mb-6 p-4 bg-gray-50 rounded-lg">
              <div className="flex items-center text-sm text-gray-600">
                ...
                <span>
                  Voting as: {publicKey.toString().slice(0, 6)}...
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-xs text-green-700 mt-1">
                    Your vote for "{submissionResponse.selectedOption}" has been
                    recorded.
                  </p>
                </div>
              </div>
