...
// import { ChatModal, ParticipantListModal } from "../modals";
// import {
//   ShareModal,
//   isMobileDevice,
// } from "@vidbloq/react";
...
//     return (
//       <>
//         {/* Chat Notification Manager - now with onOpenChat prop */}
//         <ChatNotificationManager
//           messages={formattedMessages}
//           participants={participants}
//           isChatOpen={showChat}
//           onOpenChat={handleOpenChat} // Pass the function to open chat
//         />
...
//             // closeFunc={() => setShowMobileMenu(false)}
//             // position="bottom"
...
//                   <components.ChatButton onClick={handleChatToggle} />
//                 ) : (
//                   <div
//                     className="bg-[#DCCCF63D] rounded-2xl h-full flex flex-col items-center justify-center"
//                     onClick={() => {
//                       setShowMobileMenu(false);
//                       handleOpenChat(); // Use handleOpenChat instead
//                     }}
//                   >
...
//                 onClick={handleOpenChat} // Use handleOpenChat
//               >
//                 {components?.ChatButton ? (
//                   <components.ChatButton onClick={handleOpenChat} />
//                 ) : (
//                   <div className="bg-[#DCCCF63D] rounded-2xl h-full flex flex-col items-center justify-center">
//                     <Icon name="chat" className="text-primary" />
//                   </div>
      ...
      render={(props: CallControlsRenderProps) => {
        ...
        return (
          <>
            ...
            {/* Main Controls UI */}
            <div
              className={`w-full max-6xl mx-auto`}
            >
              <div className="flex items-center justify-between">
                {/* Left group - Link and Menu icons */}
                <div className="bg-[#F2EFFE] rounded-full lg:py-2 lg:px-3 flex items-center space-x-2">
