...
const ChatModal = ({ participants, isOpen, onClose }: ChatModalProps) => {
  ...
  return (
    <Modal
      onClose={onClose}
      position="right"
      childClassName="bg-[var(--sdk-bg-primary-color)] h-full w-full sm:w-[85%] md:w-[70%] lg:w-1/4 rounded-none sm:rounded-l-xl"
    >
      <div className="flex flex-col h-full">
            ...
            return (
              <div key={chat.id || index} className="mb-3 flex items-start">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-1 break-words text-gray-700 text-sm sm:text-base">
        ...
        {/* Fixed input area */}
        <div className="flex-shrink-0 p-4 bg-[var(--sdk-bg-primary-color)] border-t border-gray-200 safe-bottom">
          <div className="flex items-center border border-primary rounded-xl overflow-hidden">
            <input
              type="text"
              className="flex-1 min-w-0 focus:outline-none px-3 py-2 sm:py-2.5 bg-transparent text-sm"
            ...
            <button
              onClick={sendMessage}
              className="flex-shrink-0 bg-primary p-2 sm:p-2.5 flex items-center justify-center cursor-pointer hover:opacity-90 transition-opacity"
