import { useNotification, useStreamContext } from "@vidbloq/react";
import { Modal } from "../ui";
import { Icon } from "../icons";

type ShareModalSimpleProps = {
  isOpen: boolean;
  onClose: () => void;
};

const ShareModalSimple = ({ onClose, isOpen }: ShareModalSimpleProps) => {
...
export default ShareModalSimple;
