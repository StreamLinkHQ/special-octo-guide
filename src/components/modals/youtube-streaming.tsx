...
// src/modals/YouTubeStreamingModal.tsx
import { useState, useCallback } from "react";
...
interface YouTubeStreamingModalProps {
  ...
  onStopStream?: () => Promise<void | boolean>;
}
...
const YouTubeStreamingModal = ({
  ...
  const handleStartStreaming = async () => {
    if (!youtubeUrl.trim() || !onStartStream) {
      return;
    }
    await onStartStream(youtubeUrl);
  };
...
// const { startRecording, stopRecording, isRecording } = useWebRecording();

  // const handleStartRecording = () => {
  //   startRecording({
  //     quality: "high", // Add quality setting
  ...
  //     quality: "high",
  //     audioTracks: meeting.tracks.microphone, // Pass LiveKit audio tracks
  //     watermarks: [
  //       {
  //         type: "image",
  //         content: "/logo.png",
