...
// import { useGetAgenda, useStreamAddons, useSubmitPollVote, useRequirePublicKey } from "@vidbloq/react";
...
// const PollTaker = ({ activeAddons: propsActiveAddons }: PollTakerProps = {}) => {
...
//   // Get the poll addon data
//   const pollAddon = activeAddons?.Poll || activeAddons?.poll;
//   const pollData = pollAddon?.data as { agendaId?: string } | undefined;
//   const pollContent = agenda?.pollContent;
//   const options = pollContent?.options || [];

//   console.log("Poll duration:", agenda?.duration);
//   console.log("Poll agenda:", agenda);
//   console.log("PollTaker Component State:", {
//     activeAddons,
//     pollAddon,
//     pollAddonIsActive: pollAddon?.isActive,
//     pollData,
//     activeAgendaId,
//     agenda: !!agenda,
...
//   // When poll becomes active, extract and set the agenda ID from addon data
//   useEffect(() => {
//     if (pollAddon?.isActive && pollData?.agendaId) {
//       console.log("Poll addon is active with agenda ID:", pollData.agendaId);
      
//       if (!hasInitialized) {
//         console.log("Initializing poll with agenda ID:", pollData.agendaId);
//         setActiveAgendaId(pollData.agendaId);
//         setHasInitialized(true);
//       } else if (activeAgendaId !== pollData.agendaId) {
//         console.log("Agenda ID mismatch, updating:", activeAgendaId, "->", pollData.agendaId);
//         setActiveAgendaId(pollData.agendaId);
//       }
//     }

//     // Reset when poll becomes inactive
//     if (!pollAddon?.isActive && hasInitialized) {
//       console.log("Poll became inactive, resetting");
//       setHasInitialized(false);
//       setActiveAgendaId(null);
//     }
//   }, [pollAddon?.isActive, pollData?.agendaId, setActiveAgendaId, hasInitialized, activeAgendaId]);
...
//   // Initialize timer when agenda is loaded and has duration
//   useEffect(() => {
//     if (agenda && agenda.duration && !hasSubmitted && !isTimerActive && !isPollExpired) {
//       // Convert string duration (minutes) to seconds
//       const durationInMinutes = Number(agenda.duration);
//       if (durationInMinutes && durationInMinutes > 0) {
//         const durationInSeconds = durationInMinutes * 60;
//         setTimeRemaining(durationInSeconds);
//         setIsTimerActive(true);
//         console.log(`Starting poll timer: ${durationInMinutes} minutes (${durationInSeconds} seconds)`);
//       }
//     }
//   }, [agenda, hasSubmitted, isTimerActive, isPollExpired]);

//   // Force refetch if agenda is null but we have an active poll
//   useEffect(() => {
//     if (activeAgendaId && pollAddon?.isActive && !agenda && !agendaLoading) {
//       console.log("Agenda is null but should have data, forcing refetch");
//       const timer = setTimeout(() => {
//         fetchAgendaData();
//       }, 500);
//       return () => clearTimeout(timer);
//     }
//   }, [activeAgendaId, pollAddon?.isActive, agenda, agendaLoading]);

//   // Reset when poll becomes inactive
//   useEffect(() => {
//     if (!pollAddon?.isActive) {
//       resetPollState();
//     }
//   }, [pollAddon?.isActive]);
...
//   // Don't render anything if poll is not active
//   // Temporarily comment out to debug
//   /*
//   if (!pollAddon?.isActive) {
//     console.log("Poll not active, not rendering", {
//       pollAddon,
//       isActive: pollAddon?.isActive,
//       activeAddons
//     });
//     return null;
//   }
...
//   // Show error state if no agenda data after loading
...
//                   Found in addon data: {pollData.agendaId}
//                 </span>
//               )}
//             </p>
//           )}
