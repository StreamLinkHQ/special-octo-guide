    ...
    <div className="fixed bottom-4 right-4 z-40">
      ...
      >
        ...
        <div className="relative">
          ...
          <div className={`absolute -top-1 -right-1 w-3 h-3 ${bgColor} rounded-full animate-ping`}></div>
          <div className={`absolute -top-1 -right-1 w-3 h-3 ${bgColor} rounded-full`}></div>
        </div>
